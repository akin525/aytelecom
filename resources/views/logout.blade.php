                                        ...
                                        <div class="position-relative h-100 d-flex flex-column">
                                            <div class="mb-4">
                                                <a href="{{route('login')}}" class="d-block">
                                                    <h2 class="text-capitalize text-white"><b>aytelecom</b></h2>
                                                </a>
                                            </div>
                                            <div class="mt-auto">
                                                <div class="mb-3">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4 text-center">
                                        ...
                                        <div class="mt-4 pt-2">
                                            ...
                                            <p class="text-muted">Thank you for using <span class="fw-semibold">aytelecom</span></p>
                                            <div class="mt-4">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0">&copy;
                                <script>document.write(new Date().getFullYear())</script> aytelecom<i class="mdi mdi-heart text-danger"></i>
                            </p>
                        </div>
                    </div>
                </div>
